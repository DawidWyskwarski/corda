 ...
 */
sealed class Screen: NavKey { //TODO rework this navigation thingy and separate it to proper modules, I will leave it for now but my next task will be to rework it
    @Serializable
